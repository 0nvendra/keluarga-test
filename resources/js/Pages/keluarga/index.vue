<template>
            ...
            <div class="tree">
                <ul>
                    <li>
                        ...
                        <ul>
                            <li
                                v-for="anak in pohonKeluarga.childs"
                                :key="anak"
                            >
                                ...
                                <ul>
                                    <li v-for="cucu in anak.childs" :key="cucu">
                                        <a
                                            style="
                                        ...
                                        <ul>
                                            ...
                                            >
                                                <a
                                                    ...
                                                    "
                                                >
                                                    {{ buyut.nama }}, anak dari
                                                    {{ cucu.nama }}
                                                </a>
                                                <ul>
                                                    <li
                                                        v-for="k4 in buyut.childs"
                                                        :key="k4"
                                                    >
                                                        <a
                                                            style="
    ...
    <div class="card mb-6 mb-xl-9">
        ...
        <div class="card-body w-100 h-100"></div>
    </div>
    <div class="card mb-6 mb-xl-9">
        <div class="card-header border-0 pt-6">
            <div class="card-title">
        ...
        <div class="card-body">
            ...
            >
                ...
                <tbody class="fw-bold text-gray-600">
                    <tr v-for="(row, i) in keluargas.data" :key="row.id">
                        <td>
                            {{ keluargas.from + i }}
                        </td>
                        <td>
                        ...
                        <td class="text-end">
                            ...
                            >
                                <Link
                                    :href="route('keluarga.show', row.id)"
                                ...
                                <Link
                                    :href="route('keluarga.edit', row.id)"
                                    type="button"
                                    class="btn btn-icon btn-sm btn-active-light-primary w-30px h-30px me-3"
                                >
                                    <span class="svg-icon svg-icon-3">
    ...
    methods: {
        ...
        _remove(id) {
            Swal.fire({
                ...
                if (result.value) {
                    this.$inertia.delete(route("keluarga.destroy", id), {
                        preserveScroll: true,
                        onSuccess: (success) => {
                            console.log(success);
                            Toast.fire({
